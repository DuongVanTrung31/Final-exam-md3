...
public class ProductDAO implements IProductDAO {
    ...
    private static final String FIND_PRODUCT_SQL = "select id_product, name_product, price, quantity, color, description, name_category from product join category on product.id_category = category.id_category where name_product like ? or name_category like ?;";
    ...
    public ArrayList<Product> findByKeyword(String keyword) {
        ...
        try {
            ...
            while (rs.next()){
                ...
                String description = rs.getString("description");
                String category = rs.getString("name_category");
                list.add(new Product(id_product, name, price, quantity, color, description, category));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
